...
.cursor/conventions/ when this repo is installed under the Cursor config root
(not skill-specific resources directories).
...
def get_convention(name: str) -> str:
    ...
    """
    # parents[4]: repo root (skills/scripts/skills/lib -> … -> root)
